...
export function Pricing({ onLoginClick }: PricingProps) {
  ...
  const pricingCards = [
    ...
    },
    {
      ...
      price: '$15/month',
      description: 'Three try outs per month with different coaches in your locked pathway — plus community, goals, and the online ISO store.',
      features: [
        '3 × 30-min try outs/month (different coaches)',
        'Locked pathway identity in community chat',
        'Locker Room chat & self-guided goals',
        'Access to Locker Room Store',
        'Priority shadowing · ISO Pass gear preview',
      ],
