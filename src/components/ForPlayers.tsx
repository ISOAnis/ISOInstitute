...
type Page = 'home' | 'for-players' | 'about' | 'community' | 'call-iso';
...
export function ForPlayers({ onNavigate, onNavigateToCallIso, commitmentStatus }: ForPlayersProps) {
      ...
      <>
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            >
              <ArrowLeft size={20} />
              <span style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Back to For Players</span>
            </motion.button>
