      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-6">
            <span className="px-4 py-2 bg-slate-900 text-white rounded-full border border-white/10">
              Six Pathways to Growth
            </span>
          </div>
          <h1 className="text-white mb-4">Explore Your Path</h1>
          <p className="text-white text-xl max-w-3xl mx-auto">
            ISO offers mentorship across six key pathways. Each pathway is
            designed to help you grow with discipline, faith, and purpose —
            guided by coaches who've walked the path before you.
          </p>
        </div>
            ...
            >
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0">
                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${pathway.color} rounded-2xl flex items-center justify-center shadow-lg`}
                  >
                    {pathway.icon && (
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white mb-3">{pathway.description}</p>
                  <p className="text-white italic">{pathway.tagline}</p>
                </div>
              </div>
            </div>
          ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white">
                Select the area where you want to grow. Each pathway has
                experienced coaches ready to guide you.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white">
                Book a session with a mentor who aligns with your goals and
                schedule.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white">
                Set micro-goals, win games, and work toward your championship
                ring — all while building discipline and faith.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 rounded-2xl border border-orange-500/30 p-6 mb-8">
          ...
          <p className="text-white text-center mb-6 text-sm">
            Progress through levels based on your commitment and growth. Start
            where you're ready.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-xs">
                    Your initial level is determined by your knowledge base and
                    experience. No need to start from the beginning if you're
                    already advanced.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-xs">
                    Each level has a minimum commitment period to ensure proper
                    growth and mastery before advancing.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-slate-900/50 rounded-2xl border border-slate-800 p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white">
                Small, actionable steps you take each week. Every bucket counts
            ...
            <div className="text-center">
              ...
              <p className="text-white">
                Complete a series of buckets to win a game. Each game represents
                a significant achievement in your pathway.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white">
                After meeting minimum timeframes and completing required games,
        ...
        <div className="mt-16 text-center">
          <p className="text-white/70 mb-6">Ready to start your journey?</p>
          <button
            className="inline-flex items-center gap-2 px-8 py-4 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-colors"
            onClick={handleExploreCourt}
          >
            Explore the Court
          </button>
        </div>
